...
def multihead_attention(queries,
    ...
    Args:
      ...
      attn_size: A scalar. Attention size, the C
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        original_emb_size = queries.get_shape().as_list()[-1]
        ...
        outputs = tf.layers.dense(outputs, original_emb_size, activation=tf.nn.relu)
