...
class InterprecsysBase:
    ...
    def __init__(self
        ...
        self.attention_size_last = attention_size_last  # TODO: what is this?
        ...
        self.pred, self.logits = None, None
        ...
        self.stacked_multi_order_feat = None
    ...
    def build_graph(self):
            ...
            for i in range(self.num_block):
                with tf.variable_scope("num_blocks_{}".format(i), reuse=tf.AUTO_REUSE):
                    features, _ = multihead_attention(
                        ...
                        attn_size=self.attention_size, num_heads=self.num_head,
        ...
        self.stacked_multi_order_feat = tf.stack(self.agg_feature_list, axis=1)  # (N, k, C)
        ...
        with tf.name_scope("Final_layer_attention"):
            ...
            feature_weights = tf.layers.dense(
                ...
                inputs=self.stacked_multi_order_feat,
            ...
            attn_multi_order_feats = tf.multiply(self.stacked_multi_order_feat, feature_weights)  # (N, k, C)
        ...
        with tf.name_scope("ctr_prediction"):
            ...
            ctr_pred_feats = tf.reduce_sum(attn_multi_order_feats, axis=1)  # (N, C)
            for i, nn in enumerate(self.pred_layers):
